...
**看著我……拜託了**
當你花費一點友情點數且你的勁敵正在觀察你時，對一次懲戒黑暗動作獲得懲罰 +2，或對一個傷痛來源獲得堅韌 +2。

**總有一天打敗你的會是我，不是他們**
當你的勁敵受到傷痛且你有某種方式保護她時，你可以花費一點友情點數來代替她承受傷痛。
...
**別擔心，我們在這裡**
當你受到傷痛或陷入危險時，花費一點友情點數；一位夥伴成員承受後果，並在該場景剩餘時間內無法行動。
...
在角色創建期間不能選擇戀愛扮演書。要選擇它，必須在故事進行過程中與另一位玩家角色或非玩家角色開始一段戀愛關係，詳情請參閱「[光與暗](/rules/light-vs-darkness/#戀愛)」章節。一旦開始戀愛，通常只能透過決裂來結束。
...
| 深刻 | 5 | 當你說明兩顆心的結合如何在困難時刻幫助你時，花費一點友情點數以降低一級黑暗等級 |
...
**我們需要談談我們要往哪裡去**
當關係達到深刻，你獲得額外一級戀愛等級，並與戀人進行一段親密場景時，你可以選擇：進行一次沒有後果的決裂並獲得一點閃耀點數，或將此扮演書更換為另一本不同的扮演書，以同一角色作為羈絆對象。然後將戀愛量表設為 2。
...
**真正重要的是我們自己**
如果你的關係達到深刻且你獲得新的一點戀愛點數，在以下選項中做出選擇：
...
| 深刻 | 5 | 當你獲得黑暗點數時，花費一點友情點數並說明你與戀愛／幻想對象的下一個計畫。避免獲得黑暗點數 |
