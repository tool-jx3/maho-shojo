...
選擇此成長後，玩家角色便可使用能力量表的超級形態。若超級形態提供新的心之力，則必須依照「[光明與黑暗](/rules/light-vs-darkness/#心之力與終曲)」章節中說明的規則來設計。若心之力標記有（），可從攻擊（A）、防禦（D）和支援（P）類別中選擇。
...
選擇此成長後，玩家角色便可使用能力量表的凱旋形態。若凱旋形態提供新的心之力，則必須依照「[光明與黑暗](/rules/light-vs-darkness/#心之力與終曲)」章節中說明的規則來設計。若心之力標記有（），可從攻擊（A）、防禦（D）和支援（P）類別中選擇。
...
關於各形態如何影響遊戲，請參閱「[光明與黑暗](/rules/light-vs-darkness/#光之裝束力量)」章節。
:::
