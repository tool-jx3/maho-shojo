...
:::note[範例]
Esther 繼續完成 Kiyomi 的扮演書，現在該選擇扮演書動作了。勇者獲得「受眷顧者」，這個動作代表她對光明力量的掌控和駕馭。獲得此動作時，她必須在三個選項中做選擇，Esther 選了以下幾項：「以正義之力」、「由心指引」（選擇「真理之光下」作為基礎動作）和「守護者的低語」。接著，作為勇者，她還獲得了「出場宣言」。
:::
