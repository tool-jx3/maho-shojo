...
在前面的章節中我們已經知道，遲早虛構敘事會觸發一個動作（參見「[基本規則](/rules/fundamentals/)」）。為了讓動作生效，並知道它如何影響虛構敘事，我們必須問自己：動作是如何被觸發的？這個問題只有一個答案：**要做某件事，你只需要去做。**
...
「懲戒黑暗」是一個玩家角色試圖擊敗黑暗使徒的動作。在判斷是否觸發這個動作時，不應該只考慮直接的戰鬥行為，例如對首領揮拳或對化身施放咒語。當提到「面對黑暗並迫使其退卻」時，這也包括說服一個被人偶附身的人拒絕黑暗，或是執行黑暗視為禁忌的行為——例如，為曾經辜負她而道歉。
...
在承受傷痛的情況下，主持人（MC）必須根據作為攻擊目標的黑暗使徒類型，明確告知你承受多少傷痛（參見「[黑暗使徒](/rules/darkness-enemies/#傷痛等級)」）。

:::note[範例 1]
在調查一間奇怪的錄影帶出租店時，魔法少女們發現店主實際上是一個黑暗首領的幻象偽裝。在突入店內後，主持人（MC）描述他如何褪去幻象偽裝，揭露自己是「噁心格洛布」。在這個揭露之後，大家變身並準備戰鬥。接著，Mónica 對 Esther 說：
...
:::note[範例 1]
依子和明里前往學生會辦公室。她們打算在收到社團關閉的通知後，要求學生會撤回決定。在被接受請求後，她們與學生會長 Gamagōri 會面。

——恐怕，各位同學，我對這個請求無能為力。這是校長的命令，社團必須關閉。

在看了看朋友之後，明里向前一步，開始引用校規，用大量的專業術語來讓 Gamagōri 困惑。經過幾分鐘的對話後，她結束說：
...
——Oneesama，我需要一個非常非常重要的幫忙——扮演登呂美的 Rosalía 說——我需要妳幫忙。明天花花終於要出新的了，然後……
...
——在那之前，我要試著分散翡翠武士的注意力，用我的身體來支援 明里。我花一點，給她的動作 +1。
...
——而且你不會孤軍奮戰，我要同時用我的戰錘攻擊。用這一點我把我的懲罰值加到清美的上面。
...
如果結果是 7 到 9，危險仍然存在，但程度較輕或較緩和。確實你避免了完整的影響，但玩家角色之後仍有一個危險要面對。最終，作為主持人（MC），你必須根據虛構敘事來詮釋結果及其後果，可能性幾乎是無限的（在「[主持人指南](/rules/mc-guide/)」章節中會更詳細地解釋這些概念）。
...
Rosalía 的角色登呂美是這部系列的超級粉絲，所以主持人（MC）在最後一題之前都沒有要求擲骰。然而，現在她認為當下的緊張氣氛可能會出問題。因此她詢問登呂美打算如何面對這個情況。

——此刻我超興奮，我要全力以赴贏得那些花花的限定明信片——Rosalía 解釋。

——好的，我想那可以算是情感和挑戰，但我覺得這次用情感比較好。你同意嗎？——玩家對主持人（MC）點頭——很好，主持人這時問道：花花的好朋友黑鐵莎拉的配音員無法在遊戲「花花 Star Quest」中為角色配音。是誰替代了她？
...
——好的，我覺得這一切開始見效了。正常的生活讓你們許多的擔憂和問題都消散了。我想這一切的主角是 明里，所以她必須用情感執行「生活故事」動作。

——不幸的是，我這方面不太行，我有 -1。所以我只骰了 7。

所有玩家都獲得一點友情點數。此外，Vanesa 決定讓明里獲得第二點友情點數，Ruth 也讓依子做了同樣的選擇。
...
:::note[範例 2]
夏美目睹了一個「光之吞噬者」出現在學校走廊中央——這是一個由負面情緒顯現的人偶，源自於一些考試不及格的同學的挫敗感。
...
:::note[範例 2]
這對登呂美來說是糟糕的一次聚會。在家裡遇到幾個問題後，她們又得探索星之王國面對一個敵人，最終累積了總共 6 點黑暗點數。在進行「抵抗黑暗」動作後，她只擲出了 5，因此她清除了 6 點黑暗點數，黑暗等級增加 1。由於角色創建時選擇了「光明子女」盟約，她確認在黑暗等級達到 5 之前不會有任何效果。
:::
...
:::note[範例 2]
夏美獲得了一個新的閃耀點數記錄在盟約扮演書上，現在她們共有 6 點。由於夏美和登呂美有 4 個成長，她們還不能觸發「閃耀時刻！」動作，因為至少需要達到 6（2 + 4）。
:::

## 友情動作

在角色創建過程中，每位玩家選擇一本友情扮演書（參見「[角色創建](/rules/character-creation/)」）和一個從相關列表中選取的友情動作。隨著獲得新的閃耀點數和成長，可以獲得額外的友情動作。

每個友情動作通常代表友情點數的替代用途，或是獲取友情點數的替代方式。這些動作代表魔法少女的光明如何利用或強化她的感情和羈絆，這是對抗黑暗最強大的武器之一。

:::note[範例 1]
清美在角色創建時選擇了友情扮演書「心之所繫」，並選擇了動作「友情的力量」。在聚會結束時，她記得有一次她在場的「生活故事」動作，因此獲得一點友情點數。
:::
...
在與夏美的玩家 Vicky 商量後，Marion 同意這是一個親密場景，因此觸發了動作「不設防的心」。在解決動作後，戀愛等級現在是 3，這將在夏美與登呂美一起執行「生活故事」動作時給予她一個優勢。
:::

## 原型動作

如同在「[角色創建](/rules/character-creation/)」章節所述，每本原型扮演書都有自己的動作，隨著獲得新的成長，可以選擇新的選項。在遊戲規則方面，玩家角色可以像使用基礎動作一樣使用原型動作，只要滿足其觸發條件即可。

作為額外說明，玩家和主持人（MC）應該對虛構敘事達成共識，以確定是否所有或部分原型動作有所限制，只能在變身為魔法少女時使用。要判斷哪些動作屬於此類，我們建議運用常識，基於你們在世界觀設定過程中決定的參數（參見「[世界觀](/rules/setting/)」）。
...
:::note[範例 1]
在角色創建過程中，Rosalía 和 Vicky 與 Marion 討論後，決定使用「光明子女」盟約扮演書。在角色創建和世界觀設定的過程中，她們創建了同伴江本咲——「星之女王」。她們在創建時選擇的盟約動作是「青春的純潔」，這將加入她們的動作列表中。
:::

:::note[範例 2]
當 Mónica、Esther、Cristina、Vanesa 和 Ruth 聚在一起進行新的 Mahō Shōjo 戰役時，她們決定嘗試「契約傀儡」盟約扮演書。在世界觀設定過程中，她們設計了守護者——一個名為貓貓優的存在，它賦予她們動作「守護者之力」。
:::
