...
:::note[範例 3]
隊伍正在與暗焰女巫對戰，她向明里發射了一顆巨大的火球。清美 花費了透過永遠在你身邊動作獲得的一個點數，將傷害轉移到自己身上。
...
:::note[範例 5]
在闖入霞真野大樓的行動中，依子被傀儡們壓制了。在逃跑動作失敗後，Mónica 使用了一個反應。
...
:::note[範例]
清美 在與暗焰女巫的戰鬥中標記了憤怒後果。從那一刻起，她在使用情感屬性進行擲骰時將減少 -2。
...
:::note[範例 1]
變身完畢面對噁心格洛布時，清美 的玩家指著他開始發表一段獨白。
...
:::note[範例 1]
Esther 目前的能力量表為 2，且可以使用基礎形態。檢查後，清美 可以使用懲罰 +1，並能發動心之力 A——她標誌性的 Celestial Burst。
:::
...
:::note[範例]
清美 的標誌性力量是 Celestial Burst，一個強大的劍擊，在她將所有風之力量集中到劍刃上時爆發。Esther 在創建時選擇了「造成等同於 5 + 玩家角色懲罰值的懲罰點數」的效果。完成後，她將其分配到心之力 A 的能力等級位置。
:::
